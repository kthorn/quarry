...
#
# DEPRECATED — SCHEMA_SQL is no longer used for database initialisation.
# Tables are now created via SQLAlchemy ORM (quarry.store.models.Base.metadata.create_all).
# See quarry/store/models.py for the canonical model definitions.
#
# The old DDL is kept below as a commented-out reference for one commit cycle.
